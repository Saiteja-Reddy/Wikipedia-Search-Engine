...
if(token == -1):
	...
	ref_count, links_count, info_count, category_count, title_count, body_count = [0 for _ in range(6)]
	for post in posting:
		# print post
		...
		if field == 'b':
			tf_idf_val = log10(1 + int(body)) * log10(5311/ body_count)
		elif field == 't':
			tf_idf_val = log10(1 + int(title)) * log10(5311/ title_count)
		elif field == 'c':
			tf_idf_val = log10(1 + int(category)) * log10(5311/ category_count)
		elif field == 'i':
			tf_idf_val = log10(1 + int(info)) * log10(5311/ info_count)
		elif field == 'l':
			tf_idf_val = log10(1 + int(links)) * log10(5311/ links_count)	
		elif field == 'r':
			tf_idf_val = log10(1 + int(ref)) * log10(5311/ ref_count)														
